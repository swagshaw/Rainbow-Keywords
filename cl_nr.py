"""
Continuous learning with naive rehearsal.
...
if __name__ == "__main__":
    ...
    if parameters.log:
        neptune.init(project_qualified_name="swagshaw/continual-learning",
                     api_token="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAu"
                               "bmVwdHVuZS5haSIsImFwaV9rZXkiOiI2OWUzZjNmZS0yYTdlLTQyNjctYWE2Mi0zODI1MTA0NzI1ZTIifQ==", )
    ...
    for task_id, task_class in enumerate(learning_tasks):
        ...
        # 0.5 nr
        train_loader, test_loader = get_dataloader_keyword(parameters.dpath, learned_class_list[len(learned_class_list)//2:], class_encoding, parameters.batch)
        # train_loader, test_loader = get_dataloader_keyword(parameters.dpath, learned_class_list, class_encoding, parameters.batch)
