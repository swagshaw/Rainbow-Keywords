...
if __name__ == "__main__":
    def options(config):
        ...
        parser.add_argument("--model", default="stft-mlp", type=str, help=["stft", "mfcc"])
    ...
    Trainer(parameters, model).model_train(0, optimizer=optimizer, train_dataloader=train_loader,
                                           valid_dataloader=test_loader)  # task id: 0
